...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/barebitcoin/btcd/rpcclient)
...
* [API Reference](https://pkg.go.dev/github.com/barebitcoin/btcd/rpcclient)
...
```bash
$ go get -u github.com/barebitcoin/btcd/rpcclient
```
